...
<div class="view view-<?php print $css_name; ?> view-id-<?php print $name; ?> view-display-id-<?php print $display_id; ?> view-dom-id-<?php print $dom_id; ?>">
  ...
  <?php if ($rows): ?>
  	<div id="feature">
        <div id="featnav">
            <ul>
                <li id="featnav1"><a href="#" class="activeSlide">1</a></li>
                <li id="featnav2"><a href="#" class="">2</a></li>
                <li id="featnav3"><a href="#" class="">3</a></li>
            </ul>
        </div>
        <div id="slider" style="position: relative; width: 400px; height: 489px;">
      	<?php print $rows; ?>
        </div>
    </div>
  <?php elseif ($empty): ?>
